...
- Elem kijelölése azonosítóval:
    ...
    ```
- Elem kijelölése osztállyal:
    ```css
    .doboz {
        background-color: yellow;
    }
    ```
- Elem kijelölése elemnévvel:
    ```css
    p {
        font-size: 16px;
    }
    ```
- Elem kijelölése több osztállyal:
    ```css
    .doboz.kicsi {
        width: 100px;
    }
    ```
- Elem kijelölése több elemnévvel:
    ```css
    h1, h2, h3 {
        color: blue;
    }
    ```
- Elem kijelölése több osztállyal és elemnévvel:
    ```css
    h1.title, p.text {
        font-size: 16px;
    }
    ```
- Elem kijelölése több elemnévvel és osztállyal:
    ```css
    h1, p.text {
        font-size: 16px;
    }
